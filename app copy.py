...
if is_detail:
    ...
    detail_cols = [
        ...
        "treatment_type","mutation_detected",
        "final_ct","family_history","country"
    ]
...
with col8:
    biomarker_input = st.selectbox("바이오마커 선택", ["", "MMX1_FAM", "MMX1_JA270", "MMX2_FAM", "MMX2_JA270", "MMX3_FAM", "MMX3_HEX", "MMX3_JA270"])
...
if biomarker_input:
    filtered = filtered[filtered[biomarker_input].notnull()]
